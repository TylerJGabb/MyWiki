    ...
    try{
        ...
        var msg = {
            ...
            bsAdEntityInformation: {
                brandShieldId:'000d4b4bc6f447448561753f1ad6aca7',
                comparisonItems:[{name : 'cmp', value : 11377819},{name : 'plmt', value : 11377826}]
            }
        };
        ...
        var findAndSendMessage = function() {
            if (!bst2tWin) {
                var frame = document.getElementById('bst2t_254168086529');
                if (frame) {
...
}, 10);var impId = '000d4b4bc6f447448561753f1ad6aca7';var dvObj = $dvbs;var rtnName = dvObj==window.$dv ? 'ImpressionServed' : 'BeforeDecisionRender';dvObj.pubSub.subscribe(rtnName, impId, 'HE_RTN', function () { try {var ifu = '';var alu = 'http://ad.doubleclick.net/ddm/clk/291583327;106680815;k';var lbl='';var d=null,e=dvObj==window.$dv?parent:window,h=0,i=0,k=[],l=[],m=10;
...
});var dvObj=$dvbs;var impId='000d4b4bc6f447448561753f1ad6aca7';dvObj.pubSub.subscribe('ImpressionServed',impId,'AttributeCollection',function(){
...
try{__tagObject_callback_254168086529({ImpressionID:"000d4b4bc6f447448561753f1ad6aca7", ServerPublicDns:"tps615.doubleverify.com"});}catch(e){}
try{$dvbs.pubSub.publish('BeforeDecisionRender', "000d4b4bc6f447448561753f1ad6aca7");}catch(e){}
try{__verify_callback_254168086529({
ResultID:2,
Passback:"",
AdWidth:728,
AdHeight:90});}catch(e){}
try{$dvbs.pubSub.publish('AfterDecisionRender', "000d4b4bc6f447448561753f1ad6aca7");}catch(e){}
